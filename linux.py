...
# Bot tokens (consider moving to environment variables for security)
bot_tokens = [
    '7151529676:AAH96JE0iX0_UOufbU64Z7S_hcXu5wIQc-A',
]

# Load admin IDs from file or use defaults
def load_admin_ids():
    try:
        with open("admins.txt", "r") as file:
            return [line.strip() for line in file if line.strip()]
    except FileNotFoundError:
        # Default admin IDs if admins.txt is missing
        return [
            "1066744659",  
            "5142603617",  
            "6140583954", 
...
def create_handlers(bot):
    ...
    def start_command(message):
        ...
        if user_id in admin_ids:
            ...
            bot.reply_to(message, "You are not authorized to use this bot : buy @spoliator_persona\n@insanoic\n@X9HYDRA & visit our telegram channel : https://t.me/+ROPChR2tcdtkOWZl")
